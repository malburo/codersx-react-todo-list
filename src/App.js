  ...
  handleClickItem = (item) => {
    return (event) => {
      ...
      this.setState({
        ...
        finished: [...finished, { ...item, isComplete: true }],
      });
    };
  };
  ...
  render() {
    ...
    noList = this.state.todos.length === 0 &&
      this.state.finished.length === 0 && (
        <img
          className="emty"
          src="https://res.cloudinary.com/malburo/image/upload/v1588845860/undraw_blooming_jtv6_lebyn9.svg"
          alt="emty"
        />
      );
    return (
      <div className="App">
        ...
        <div className="body">
          ...
          <Finished
            ...
            onClick={this.handleClickItemFinished}
          />
        </div>
        <NewTodo
